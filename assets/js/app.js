...
function modalContentEnter(){
    modalContent.classList.remove("opacity-0", "hidden", "translate-y-4", "sm:translate-y-0", "sm:scale-95");
    modalContent.classList.add("ease-out", "duration-300", "opacity-100", "translate-y-0", "sm:scale-100");
}
...
window.addEventListener("DOMContentLoaded", function() {
    ...
    function error() {
        status.innerHTML = " <div class=\"rounded-md bg-red-50 p-4\">\n" +
            "  <div class=\"flex\">\n" +
